...
def build_prompt(question: str, contexts: list[tuple[Chunk, float]]) -> str:
    ...
    return f"""
    Bạn là trợ lý du lịch thân thiện của resort. Chỉ trả lời dựa trên CONTEXT.
Nếu CONTEXT không có thông tin, hãy nói rõ bạn chưa có dữ liệu và gợi ý khách hỏi lễ tân.
